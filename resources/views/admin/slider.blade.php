...
form:after{
   display: inline;
          ...
          <div class="row">
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                     ...
                     <button type="button" class="btn btn-info " data-toggle="modal" data-target="#myModal{{$item->id}}"><span class="glyphicon glyphicon-pencil"></span>Edit</button>
                       ...
                       <form class="deleteform" action="\delete-slider" method="post" style="display: inline-block;">
                       {{ csrf_field() }}
                          ...
                          <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="col-md-12">
                                   <form class="form-horizontal form-label-left" action="\update-slider\{{$item->id}}" method="post" enctype="multipart/form-data">
                                     {{ csrf_field() }}
                                     <div class="row">
            ...
            <div class="col-md-12">
               <form class="form-horizontal form-label-left" action="\add-slider" method="post" enctype="multipart/form-data" >
     {{ csrf_field() }}
     <div class="form-group">
     ...
     <div class="form-group">
       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name TR<span class="required">*</span>
       </label>
       <div class="col-md-6 col-sm-6 col-xs-12">
