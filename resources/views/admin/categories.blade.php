...
form:after{
   display: inline;
          ...
          <div class="row">
                          ...
                          <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="col-md-12">
                                   <form class="form-horizontal form-label-left" action="\update-Category\{{$item->id}}" method="post" enctype="multipart/form-data">
                                     {{ csrf_field() }}
                                     <div class="row">
                                       <div class="form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Category Name AR<span class="required">*</span>
                                         </label>
                                         ...
                                         <div class="row">
                                       <div class="form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Category Name TR<span class="required">*</span>
                                         </label>
                                         <div class="col-md-6 col-sm-6 col-xs-12">
                                           <input type="text" id="name" name="name_tr" value="{{$item->name_tr}}" required="required" class="form-control col-md-7 col-xs-12">
                                         </div>
                                       </div>
                                     </div>
                                     <div class="row">
                                 ...
                                 <div class="row">
                               <div class="form-group">
                                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Category Parint<span class="required">*</span>
                                 </label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control col-md-7 col-xs-12" name="parent_id">
                                      <option value="">Parint</option>
                                       @foreach($parint_categories as $item)
            ...
            <div class="col-md-12">
               <form class="form-horizontal form-label-left" action="\add-category" method="post" enctype="multipart/form-data">
     {{ csrf_field() }}
     <div class="form-group">
       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Category Name EN<span class="required">*</span>
       </label>
