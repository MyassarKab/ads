...
<div class="banner text-center">
	  <div class="container">
	  		<h1> Sell or Advertise   <span class="segment-heading">    anything online </span> with Teba</h1>
                  <p> Mobiles</p>
...
<!-- 			<div class="all-categories">
			...
			<ol class="breadcrumb" style="margin-bottom: 5px;">
			  ...
			  <li class="active">All Mobiles</li>
			</ol>
			<div class="ads-grid">
						  ...
						  <div>
							...
							<ul class="list">
								<a href="single.html">
									...
									<section class="list-right">
									<span class="date">Today, 17:55</span>
									<span class="cityname">Turkey</span>
									</section>
									<div class="clearfix"></div>
									</li>
								</a>
